      ...
      <v-container class="kolomtxt">
        <v-card class="d-flex flex-column" width="100%" color="transparent" flat>
          <!-- <form @submit.prevent="handleSubmit"> -->
            ...
            <v-btn style="width:100%;" type="submit" v-on:click="validate" :disabled="username == '' || password == '' ? true : false">Submit</v-btn>
            
            <v-btn style="width:100%;" v-on:click="dialog=true">Register</v-btn>
